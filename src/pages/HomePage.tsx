...
export default function HomePage() {
  ...
  return (
    <div className="relative">
      {/* ===== HERO ===== */}
      <section className="relative min-h-[100dvh] flex flex-col items-center justify-center overflow-hidden px-5 py-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center mt-10 sm:mt-0">
          <motion.div
